...
var _ItemList = __webpack_require__(76);
...
var _NotFound = __webpack_require__(79);
...
var ItemList = function (_React$Component) {
  ...
  function ItemList(props) {
    ...
    _this.state = { items: _storage.items, order: "desc", fieldToSort: "id" };
    return _this;
  }
  ...
  _createClass(ItemList, [{
    ...
    value: function sort() {
      ...
      var field = this.state.fieldToSort;
      console.log(order, field);
      function compareByField(a, b) {
        return order == "asc" ? a[field] - b[field] : b[field] - a[field];
      }

      _storage.items.sort(compareByField);

      this.setState({ items: _storage.items });
    }
  }, {
