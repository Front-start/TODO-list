...
var _SortArray = __webpack_require__(79);
...
var ItemList = function (_React$Component) {
  ...
  function ItemList(props) {
    ...
    _this.updateSortingField = _this.updateSortingField.bind(_this);
    _this.updateSortingOrder = _this.updateSortingOrder.bind(_this);

    _this.state = {
      items: _storage.ItemsStorage.items,
      order: "desc",
      fieldToSort: "id"
    };
    return _this;
  ...
  _createClass(ItemList, [{
    key: "sort",
    value: function sort() {
      _SortArray.SortArray.sort(_storage.ItemsStorage.items, this.state.fieldToSort, _storage.ItemsStorage.fields[this.state.fieldToSort].type, this.state.order);

      this.setState({ items: _storage.ItemsStorage.items });
    }
  }, {
    key: "updateSortingField",
    value: function updateSortingField(e) {
      this.setState({ fieldToSort: e.target.value });
    }
  }, {
    key: "updateSortingOrder",
    value: function updateSortingOrder(e) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "select",
          { onChange: this.updateSortingField },
          Object.keys(_storage.ItemsStorage.fields).map(function (key) {
            return _react2.default.createElement(
              "option",
              { key: key, value: key },
              _storage.ItemsStorage.fields[key].name
            );
          })
        ),
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  "li",
                  null,
                  _storage.ItemsStorage.fields.id.name,
                  " ",
                  item.id
                ),
                _react2.default.createElement(
                  "li",
                  null,
                  _storage.ItemsStorage.fields.date.name,
                  " ",
                ...
                _react2.default.createElement(
                  "li",
                  null,
                  _storage.ItemsStorage.fields.date2.name,
                  " ",
                ...
                _react2.default.createElement(
                  "li",
                  null,
                  _storage.ItemsStorage.fields.name.name,
                  " ",
                  item.name
                ),
                _react2.default.createElement(
                  "li",
                  null,
                  _storage.ItemsStorage.fields.content.name,
                  " ",
                  item.content
                )
              )
        ...
        _react2.default.createElement("input", { type: "button", value: "\u041E\u0442\u0441\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C", onClick: this.sort })
      );
    }
  }]);
...
var _ItemList = __webpack_require__(35);
...
var Main = function (_React$Component) {
  ...
  _createClass(Main, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(_ItemList2.default, null);
    }
  }]);
...
var ItemsStorage = exports.ItemsStorage = {
  fields: {
    id: { type: "number", name: "№" },
  ...
  items: [{
    ...
    date: 1514704590000,
    date2: 151484590000,
    content: "Односвязный список – это структура данных, которая состоит из элементов, каждый из которых хранит ссылку на следующий. Последний элемент может не иметь ссылки, либо она равна null."
  }, {
    id: 2,
    name: "[WDS] Disconnected!",
    date: 1514704890000,
    date2: 1516704890000,
    content: "При выполнении этого кода всплывет предупреждение о том, что для элементов списка требуется ключ. «Key» — это специальный строковый атрибут, который нужно включить при создании списков элементов. В следующем разделе мы расскажем, почему он так важен."
  }, {
    id: 3,
    name: "Здесь определен компонент ClickButton, который по сути представляет кнопку",
    date: 1514706590000,
    date2: 1515706590000,
    content: "Этот код заносит [2, 4, 6, 8, 10] в консоль. В React преобразование массивов устройств в списки элементов происходит аналогичным образом."
  }, {
    id: 4,
    name: "Для начала, давайте рассмотрим, как преобразовать списки в JavaScript",
    date: 1514714590000,
    date2: 1514914590000,
    content: "Мы контролируем не только равномерность по наполнению, но и форму факела распыляемого топлива. Для бензиновых форсунок критичным параметром, позволяющим определить необходимость промывки, является время впрыска и состояние топливной смеси."
  }, {
    id: 5,
    name: "Запотеть катку",
    date: 1514703590000,
    date2: 1514743590000,
    content: "Ключи, используемые в массивах устройств должны быть уникальными среди своих братьев. Тем не менее, они не должны быть абсолютно уникальным. Можно использовать одни и те же ключи, при создании двух разных массивов."
  }]
};
...
var SortArray = exports.SortArray = {
  sort: function sort(array, field, type, order) {
